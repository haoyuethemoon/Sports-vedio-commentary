...
class BaseASR:
    ...
    def get_audio_frame(self):
        ...
        return frame,type,eventpoint,self.pause,self.gen
    ...
    def warm_up(self):
        for _ in range(self.stride_left_size + self.stride_right_size):
            audio_frame,type,eventpoint,pe,gen=self.get_audio_frame()
            self.frames.append(audio_frame)
            self.output_queue.put((audio_frame,type,eventpoint,pe,gen))
